...
export const APP_SETTINGS_FIELD_OWNERS: { readonly [K in keyof AppSettingsV1]-?: SettingsFieldOwner } = {
  ...
  composerSendKey: 'core', cursorSpotlight: 'core', cursorSpotlightColor: 'core', darkUiColors: 'core', provider: 'provider', agents: 'kun',
  ...
  guiUpdate: 'update', privacyMode: 'core', terminal: 'terminal', codePromptPrefix: 'core', chatWelcomeMessage: 'core',
